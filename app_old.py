...
from handlers.message_handlers import chatgpt_reply, generate_excuse
...
excuse_command_handler = CommandHandler("generate_excuse", generate_excuse)
application.add_handler(excuse_command_handler)
